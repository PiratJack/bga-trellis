    ...
    function(dojo, declare) {
        return declare("ebg.scrollmapWithZoom", null, {
            constructor: function() {
                ...
                this.zoomingOptions = {
                    wheelZoming: this.wheelZoomingKeys.Any,
                    pinchZooming: true
                };
                this.zoomControlOptions = {
                    position: this.ControlPosition.LEFT_CENTER
                };
            ...
            setupOnScreenArrows: function(scrollDelta, bScrollDeltaAlignWithZoom = true) {
                ...
                if (!this._btnMoveTop)
                    this._btnMoveTop = this._initButton('movetop', this.onMoveTop, () => {
                        this.scroll(0, 3, 0, 0);
                    });
                if (!this._btnMoveDown)
                    this._btnMoveDown = this._initButton('movedown', this.onMoveDown, () => {
                        this.scroll(0, -3, 0, 0);
                    });
                if (!this._btnMoveLeft)
                    this._btnMoveLeft = this._initButton('moveleft', this.onMoveLeft, () => {
                        this.scroll(3, 0, 0, 0);
                    });
                if (!this._btnMoveRight)
                    this._btnMoveRight = this._initButton('moveright', this.onMoveRight, () => {
                        this.scroll(-3, 0, 0, 0);
                    });
            },
            ...
            setupOnScreenZoomButtons: function(zoomDelta = 0.2) {
                ...
                if (!this._btnZoomPlus)
                    this._btnZoomPlus = this._initButton(this._btnZoomPlusNames, this.onZoomIn, () => {
                        this.changeMapZoom(0.02);
                    });
                if (!this._btnZoomMinus)
                    this._btnZoomMinus = this._initButton(this._btnZoomMinusNames, this.onZoomOut, () => {
                        this.changeMapZoom(-0.02);
                    });
            ...
            setupEnlargeReduceButtons: function(incrHeightDelta, incrHeightKeepInPos, minHeight) {
                ...
                if (!this._btnIncreaseHeight)
                    this._btnIncreaseHeight = this._initButton('enlargedisplay', this.onIncreaseDisplayHeight, () => {
                        this.changeDisplayHeight(5);
                    }, btnsProps.idSuffix, btnsProps.display);

                if (!this._btnDecreaseHeight)
                    this._btnDecreaseHeight = this._initButton('reducedisplay', this.onDecreaseDisplayHeight, () => {
                        this.changeDisplayHeight(-5);
                    }, btnsProps.idSuffix, btnsProps.display);
